analyze_ESM_caom <- function(dat, var, min_diff, max_diff) {
  library(tidyverse)
  ...
  # Analyze the data 
      ...
      if (length(valid_models) < 1) {
        return("Your data for this characteristic could not be successfully analyzed")
      }
      ...
      }, error = function(e) "Your data for this characteristic could not be successfully analyzed")
